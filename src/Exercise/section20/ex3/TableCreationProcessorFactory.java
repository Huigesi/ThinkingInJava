package Exercise.section20.ex3;

import Exercise.annotations.database.*;
        ...
        private class TableCreationVisitor extends SimpleDeclarationVisitor {
            ...
            public void visitFieldDeclaration(FieldDeclaration d) {
                ...
                if (d.getAnnotation(SQLBoolean.class) != null) {
                    SQLBoolean sqlBoolean = d.getAnnotation(SQLBoolean.class);
                    ...
                    sql+="\n   " + columnName + " BOOLEAN("  +
                              getConstraints(sqlBoolean.constrains()) + ",";
                }
            }
